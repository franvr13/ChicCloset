...
CREATE TABLE IF NOT EXISTS `TiendaRopa`.`producto` (
  ...
  `devoluciones_pedidos_id` INT NOT NULL,
  `precio` DECIMAL(10,2) NOT NULL,
  PRIMARY KEY (`id`, `devoluciones_id`, `devoluciones_pedidos_id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `TiendaRopa`.`productos_pedidos`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `TiendaRopa`.`productos_pedidos` ;

CREATE TABLE IF NOT EXISTS `TiendaRopa`.`productos_pedidos` (
  `ID` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `TiendaRopa`.`devoluciones` (
  ...
  PRIMARY KEY (`id`, `producto_pedido_id`),
  INDEX `FK_producto_pedido_id_idx` (`producto_pedido_id` ASC) VISIBLE,
  CONSTRAINT `FK_producto_pedido_id`
    FOREIGN KEY (`producto_pedido_id`)
    REFERENCES `TiendaRopa`.`productos_pedidos` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `TiendaRopa`.`subcategoria`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `TiendaRopa`.`subcategoria` ;

CREATE TABLE IF NOT EXISTS `TiendaRopa`.`subcategoria` (
  `producto_id` INT NOT NULL,
  `producto_devoluciones_id` INT NOT NULL,
  `producto_devoluciones_pedidos_id` INT NOT NULL,
  `categoria_id` INT NOT NULL,
  INDEX `fk_subcategoria_producto1_idx` (`producto_id` ASC, `producto_devoluciones_id` ASC, `producto_devoluciones_pedidos_id` ASC) VISIBLE,
  INDEX `fk_subcategoria_categoria1_idx` (`categoria_id` ASC) VISIBLE,
  CONSTRAINT `fk_subcategoria_producto1`
    FOREIGN KEY (`producto_id` , `producto_devoluciones_id` , `producto_devoluciones_pedidos_id`)
    REFERENCES `TiendaRopa`.`producto` (`id` , `devoluciones_id` , `devoluciones_pedidos_id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
